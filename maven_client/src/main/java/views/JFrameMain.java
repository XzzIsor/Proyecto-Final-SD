...
public class JFrameMain extends javax.swing.JFrame {
    ...
    private void btnConsultarPActionPerformed(java.awt.event.ActionEvent evt){
        if(!jTFNombreP.getText().isEmpty()){
            ...
            if(product != null){
                jTFCodP.setText(product.getCod().toString());
    ...
    private void btnSubastarPActionPerformed(java.awt.event.ActionEvent evt){
        ...
        if(flag){
            ...
            if(auctionProduct != null){
                jTFNombrePr.setText(auctionProduct.getName());
                jTFCodPr.setText(auctionProduct.getCod().toString());
                jTFValor.setText(String.valueOf(auctionProduct.getValue()));
                jTFEstadoPr.setText(auctionProduct.getStatus());
            }
        ...
        if(!jTFValorPuja.getText().isEmpty()){
            ...
            if(flag){
                ...
                if(product.getValue() < value){
                    ...
                    if(newProduct != null){
                        JOptionPane.showMessageDialog(this, "Puja Aceptada");
                        jTFCodPr.setText(String.valueOf(newProduct.getCod()));
                        jTFNombrePr.setText(newProduct.getName());
                        jTFEstadoPr.setText(newProduct.getStatus());
                    ...
                    JOptionPane.showMessageDialog(this, "La puja debe ser mayor a la actual");
                }
            }else{
                JOptionPane.showMessageDialog(this, "No hay producto en subasta actualmente");
            }
        }else{
